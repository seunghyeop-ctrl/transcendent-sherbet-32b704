...
- Settings live in ~/Library/Application Support/PromptExtractor
- Output data lives in ~/Documents/프롬프트 추출기
"""
...
APP_SUPPORT_DIR = Path.home() / "Library" / "Application Support" / "PromptExtractor"
CONFIG_PATH = APP_SUPPORT_DIR / "config.json"
DEFAULT_CREDENTIALS_PATH = APP_SUPPORT_DIR / "credentials.json"
DEFAULT_OUTPUT_ROOT = Path.home() / "Documents" / "프롬프트 추출기"
...
def detect_camera_movement(prompt: str) -> str:
    ...
    keyword_map = [
        ...
        ([("steadicam", "tracking"), ("front tracking shot",), ("tracking shot", "steadicam"), ("steadicam", "flying")], "Steadicam tracking"),
...
def export_row(raw_row: dict) -> dict[str, str]:
    return {
        ...
        "내용": build_korean_summary(raw_row),
        "링크": raw_row.get("URL", ""),
    }
